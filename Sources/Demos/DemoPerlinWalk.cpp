...
namespace nkentseu {
 ...
 position = math::Vector2(GetWindowWidth() / 2.0f, GetWindowHeight() /
2.0f);
 Background(graphics::Color::White);
 }

  void DemoPerlinWalk::Update(float deltatime) {(void) deltatime;}
 ...
 position.x = math::Random::Map(noiseX, 0.0f, 1.0f, 0.0f,
(float)GetWindowWidth());
 position.y = math::Random::Map(noiseY, 0.0f, 1.0f, 0.0f,
